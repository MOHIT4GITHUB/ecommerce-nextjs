                ...
                <div className="flex-[4] p-4">
                    ...
                    <div className="py-2 text-sm flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-1 ">
                            <div className="px-8 py-4 rounded-sm cursor-pointer bg-neutral-200"></div>
                            <div className="px-8 py-4 rounded-sm cursor-pointer bg-neutral-300"></div>
                            <div className="px-8 py-4 rounded-sm cursor-pointer bg-neutral-400"></div>
                            <div className="px-8 py-4 rounded-sm cursor-pointer bg-neutral-500"></div>
                            <div className="px-8 py-4 rounded-sm cursor-pointer bg-neutral-600"></div>
                        </div>
                    </div>
                    ...
                    <div className="py-2 flex items-center gap-4">
                        ...
                        <button className="flex items-center gap-1 bg-slate-800 font-semibold text-white px-4 py-2 rounded-full shadow-sm">
